...
class SubscriptionRepository(ISubscriptionRepository):
    ...
    def add(self, account_id: int, package_id: int, start_date: Optional[date], end_date: date,
            remaining_credits: int, status: str) -> Subscription:
        try:
            sub_model = SubscriptionModel(
                account_id=account_id, package_id=package_id, start_date=start_date,  # NULL allowed
