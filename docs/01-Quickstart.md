...
└── api/                 # API Layer
    ...
    └── schemas/         # Marshmallow Schemas (18)
```
...
1. **01-Quickstart.md** - Quick start guide (this file)
2. **02-Architecture.md** - Clean Architecture overview
3. **03-Database-Models.md** - Database models & tables
4. **04-Repositories.md** - Repository layer documentation
5. **05-Services.md** - Business logic layer
6. **06-Controllers.md** - API controllers & endpoints
7. **07-Schemas-Refactoring.md** - Marshmallow schemas refactoring
...
4. ⏭️ **Write Tests** - Unit tests & Integration tests
5. ⏭️ **Deploy** - Containerize và deploy lên cloud
